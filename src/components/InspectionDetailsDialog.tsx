                    ...
                    return (
                      <div key={unitKey} className="border rounded-lg overflow-hidden">
                        ...
                        <button
                          ...
                          className={`sticky top-0 z-20 w-full px-4 py-3 flex items-center justify-between text-sm font-semibold hover:bg-accent/50 transition-colors ${
                              ...
                              return (
                                <div key={roomKey}>
                                  ...
                                  <button
                                    ...
                                    className={`sticky top-0 z-10 w-full px-3 py-2 flex items-center justify-between text-sm font-medium hover:bg-accent/50 transition-colors border-b ${
